...
export default function Sidebar({ perfil }: Props) {
  ...
  const gestion = [
    ...
    { label: 'Temáticas Especiales', href: '/tematicas', icon: <Icon d="M12 22a10 10 0 100-20 10 10 0 000 20zm0-4a6 6 0 100-12 6 6 0 000 12zm0-4a2 2 0 100-4 2 2 0 000 4z" /> },
  ]
  const analisis = [
